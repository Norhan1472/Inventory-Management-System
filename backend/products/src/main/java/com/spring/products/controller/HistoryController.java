...
public class HistoryController {
    ...
    @GetMapping("getByAnyThing/name/{name}/value/{value}")
    public ResponseEntity<List<History>>getByAnyThing(@PathVariable String name,@PathVariable String value){
        return new ResponseEntity<>(historyService.findByAnyThing(name,value),HttpStatus.OK);
    }
